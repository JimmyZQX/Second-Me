...
def main():
    ...
    try:
        ...
        if bio_obj and bio_obj.content_third_view:
            ...
            print(f"✅ Found user bio ({len(user_bio)} characters)")
        else:
            print("⚠️ No user bio found, using empty bio")
    except Exception as e:
        print(f"⚠️ Warning: Could not get user bio: {str(e)}")
    ...
    # Initialize judge
    try:
        print(f"\n🔧 Initializing MergedDataJudge...")
        judge = MergedDataJudge(
            model_name="gemma:2b",
            ollama_host="http://localhost:11434",
            user_bio=user_bio
        )
        print("✅ MergedDataJudge initialized successfully")
    except Exception as e:
        print(f"❌ Error initializing MergedDataJudge: {str(e)}")
        return False
